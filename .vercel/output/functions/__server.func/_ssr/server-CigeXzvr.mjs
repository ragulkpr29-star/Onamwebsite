...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-CigeXzvr.js
var server_CigeXzvr_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CD8IkNS1.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DMlQUwPC.mjs").then((n) => n.t),
		import("./start-BLH-vSDn.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_CigeXzvr_exports as t };
